...
>
    ...
    <svg x-show="muted" x-cloak class="fi-icon {{ $menuItem ? 'fi-size-md' : 'fi-size-lg' }}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
